    ...
    r.app.menu = {
        ...
        manualScroller: {
            ...
            update: function () {
                ...
                //        var e, n;
                //        if (e = i.querySelector(".main-menu-content li.active"), l.hasClass("menu-collapsed")) r(".main-menu-content li.sidebar-group-active").length && (e = i.querySelector(".main-menu-content li.sidebar-group-active"));
                //        else if (n = i.querySelector(".main-menu-content"), (e = e.getBoundingClientRect().top + n.scrollTop) > parseInt(2 * n.clientHeight / 3)) var a = e - n.scrollTop - parseInt(n.clientHeight / 2);
                //        setTimeout(function () {
