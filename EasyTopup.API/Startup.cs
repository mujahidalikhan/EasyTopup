using EasyTopup.API.Authentication;
...
using EasyTopup.API.Repositories;
using EasyTopup.API.Controllers;

namespace EasyTopup.API
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddMvc();
            // ===== Add Swagger ========
            services.AddSwaggerGen(c => { c.SwaggerDoc("v1", new Info { Title = "EasyTopup API", Description = "EasyTopup API Description" }); });
        ...
        public void Configure(IApplicationBuilder app, IHostingEnvironment env, ApplicationDbContext dbContext, IServiceProvider serviceProvider)
        {
            ...
            app.UseSwagger();
            app.UseSwaggerUI(c => { c.SwaggerEndpoint("/swagger/v1/swagger.json", "EasyTopup API"); });
            ...
            UserController._hostingEnvironment = env;
        }
        ...
        private async Task CreateRoles(IServiceProvider serviceProvider)
        {
            ...
            string[] roleNames = { "Admin", "Company", "Shop" };
