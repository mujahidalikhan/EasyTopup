...
namespace EasyTopup.API.Migrations
{
    ...
    [Migration("20200219145419_Shop_Registration_Number")]
    partial class Shop_Registration_Number
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("EasyTopup.Data.Models.Card", b =>
                {
                    ...
                    b.Property<string>("SaleViewModelUserId");
                    ...
                    b.HasIndex("SaleViewModelUserId");
            ...
            modelBuilder.Entity("EasyTopup.Data.ViewModels.CreateSaleViewModel", b =>
                {
                    ...
                    b.Property<string>("SoldByEmail");

                    b.Property<string>("SoldByName");

                    b.HasKey("Code");

                    b.ToTable("CreateSaleViewModel");
                });
            ...
            modelBuilder.Entity("EasyTopup.Data.ViewModels.SaleViewModel", b =>
                {
                    b.Property<string>("UserId")
                        .ValueGeneratedOnAdd();
                    ...
                    b.Property<string>("createSaleViewModelCode");
                    ...
                    b.HasIndex("createSaleViewModelCode");

                    b.ToTable("SaleViewModel");
                });
            ...
            modelBuilder.Entity("EasyTopup.Data.Models.Card", b =>
                {
                    b.HasOne("EasyTopup.Data.ViewModels.SaleViewModel")
                        .WithMany("listCards")
                        .HasForeignKey("SaleViewModelUserId");
                });
            ...
            modelBuilder.Entity("EasyTopup.Data.ViewModels.SaleViewModel", b =>
                {
                    b.HasOne("EasyTopup.Data.ViewModels.CreateSaleViewModel", "createSaleViewModel")
                        .WithMany()
                        .HasForeignKey("createSaleViewModelCode");
                });
